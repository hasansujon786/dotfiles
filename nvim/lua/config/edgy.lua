local make_winhighlight = require('nebulous.utils').make_winhighlight
...
util.fg_bg('EdgyWinBarDark', cyan, bg_dark)
util.fg_bg('EdgyWinBarLight', cyan, bg_gray)
util.fg_bg('EdgyNormalDark', fg, bg_dark)

local dark_bar = make_winhighlight({
...
local gray_bar = make_winhighlight({
