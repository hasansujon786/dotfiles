...
local list = {
  ...
  -- { key = {"<2-RightMouse>", "<C-]>", "l"},    action = "cd" },
  { key = {"-"},                          action = "dir_up" },
...
vim.cmd[[
  nnoremap - :lua Toggle_replace()<CR>
  nnoremap <BS> <c-^>
  nnoremap <leader>op :NvimTreeFindFileToggle<CR>
  nnoremap <leader>ob :NvimTreeFocus<CR>
  nnoremap <leader>0  :NvimTreeFocus<CR>
