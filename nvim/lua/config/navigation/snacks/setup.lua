...
local layout = require('config.navigation.snacks.layout')
...
require('snacks').setup({
  ...
  picker = {
    ...
    layouts = layout.picker_layouts,
    kinds = {
      codeaction = { layout = 'cursor' },
    },
    sources = {
      -- 'dropdown'
      ...
      lsp_symbols = { layout = 'right_float', win = preview_main_win },
      treesitter = {
        layout = 'right_float',
