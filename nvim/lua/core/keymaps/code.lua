...
local maps = {
  ...
  { "<leader>.", "<cmd>lua require(\"vscode\").action(\"workbench.action.showAllEditors\")<CR>", mode = { "n", "x" } },
  ...
  { "]d", "<cmd>lua require(\"vscode\").action(\"editor.action.marker.next\")<CR>", mode = { "n", "x" } },
  { "[d", "<cmd>lua require(\"vscode\").action(\"editor.action.marker.prev\")<CR>", mode = { "n", "x" } },
  ...
  { "[x", "<cmd>lua require(\"vscode\").action(\"editor.action.dirtydiff.prev\")<CR>", mode = { "n", "x" } },
  { "]x", "<cmd>lua require(\"vscode\").action(\"editor.action.dirtydiff.next\")<CR>", mode = { "n", "x" } },
  ...
  { "k", "v:count == 0 ? \"gk\" : \"k\"", remap = true, desc = "Move cursor up", expr = true },
  { "j", "v:count == 0 ? \"gj\" : \"j\"", remap = true, desc = "Move cursor down", expr = true },
