...
local maps = {
  { "Q", M.record_macro, expr = true, desc = "Record a macro", mode = { "n", "x" } },
  { "<C-v>", "<C-R>+", silent = false, desc = "Paste from system clipboard", mode = { "i", "c" } },
  { "<C-g><C-v>", "<C-v>", silent = false, desc = "Paste from system clipboard", mode = { "i", "c" } },
  { "<A-p>", "<C-R>\"", silent = false, desc = "Paste the last item from register", mode = { "i", "c" } },
  ...
  { "zuu", "0vai:foldclose!<CR>zazt", mode = { "n", "x" }, desc = "Fold current context", remap = true },
  { "zu", ":foldclose!<CR>zazt", mode = { "n", "x" }, desc = "Fold current context", remap = true },
  ...
  { "<A-u>", "<C-u>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-d>", "<C-d>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-o>", "<C-d>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<PageUp>", "<C-u>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<PageDown>", "<C-d>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-f>", "<C-f>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-b>", "<C-b>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-y>", "<C-y>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-e>", "<C-e>", mode = { "n", "x" }, desc = "Scroll window", remap = true },
  { "<A-h>", "20zh", mode = { "n", "x" } },
  { "<A-l>", "20zl", mode = { "n", "x" } },
