...
local maps = {
  ...
  { "<C-g><C-v>", "<C-v>", mode = { "i", "c" }, desc = "Paste from system clipboard", silent = false },
  { "<A-p>", "<C-R>\"", mode = { "i", "c" }, desc = "Paste the last item from register", silent = false },
  { "<A-k>", "<esc><cmd>m .-2<cr>==gi", mode = "i", desc = "Move Up" },
  { "<A-j>", "<esc><cmd>m .+1<cr>==gi", mode = "i", desc = "Move Down" },
  { "<C-_>", "mz_gcc`z", mode = "n", desc = "Toggle comment line", remap = true },
  { "<C-_>", "<ESC>_gccgi", mode = "i", desc = "Toggle comment line", remap = true },
  { "<C-_>", "mz_gcgv`z", mode = "v", desc = "Toggle comment line", remap = true },
