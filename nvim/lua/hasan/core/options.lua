...
-- o.guifont = 'FiraCode NF:h12:w6' --              OperatorMonoLig Nerd Font:h16
o.guifont = 'JetBrains Mono NL:h12:w6' --              OperatorMonoLig Nerd Font:h16
o.guicursor =
  'n-v-c:block,i-ci-ve:ver25,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175'
o.title = true
o.titlelen = 20
o.titlestring = '%= %{fnamemodify(getcwd(), ":t")}%w%<%=' -- what the title of the window will be set to
