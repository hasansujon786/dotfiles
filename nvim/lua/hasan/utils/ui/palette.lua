...
local function set_custom_highlights()
  ...
  local highlights = {
    ...
    OrgFolded               = { fg = c.none, bg = c.none },
    Visual                  = { bg = c.dim_blue },
    NonText                 = { fg = c.layer, bg = c.none },
    LineNr                  = { fg = '#495162', bg = c.none },

    StatusLine              = { fg = c.muted, bg = c.none },
    HeirlineLayer           = { fg = c.light_grey, bg = c.layer },
    HeirlineLayerEdge       = { fg = c.layer, bg = c.none },
    HeirlineLayerDivider    = { fg = c.bg_d, bg = c.layer },

    HeirlineTabActive       = { fg = c.green, bg = c.layer },
    HeirlineTabInactive     = { fg = c.red, bg = c.layer },
    HeirlineRECLeft         = { fg = c.red, bg = c.bg1 },
    HeirlineREC             = { fg = c.white, bg = c.red },
    HeirlineRECRight        = { fg = c.red, bg = c.layer },

    WinbarTabEmpty          = { fg = c.muted, bg = c.bg_d },
    WinbarTabContent        = { fg = c.fg },
    WinbarTabContentInactive= { fg = c.muted },
    WinbarTabEdgeLeft       = { fg = c.blue },
    WinbarTabEdgeRight      = { fg = c.black },
    ...
    SnacksDashboardFile     = { link = 'SnacksDashboardDesc' },
    SnacksDashboardIcon     = { link = 'SnacksDashboardDesc' },
    SnacksDashboardKey      = { bg = c.none, fg = c.light_grey, italic = false },
    ...
    FloatTitle              = { link = 'SnacksPickerTitle' },
    SnacksPickerToggle      = { fg = c.dark_green, bg = dark_border },
  ...
  local links = {
    ...
    ['@keyword.repeat'] = '@keyword.function',
    ['@keyword.return.javascript'] = '@keyword.function',
    ['@keyword.exception.javascript'] = '@keyword.function',
